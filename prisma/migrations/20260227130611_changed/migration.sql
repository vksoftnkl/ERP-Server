/*
  ...
  - You are about to drop the column `led_cheque_name` on the `acc_ledger_master` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "accounts"."acc_ledger_master" DROP COLUMN "led_cheque_name",
ADD COLUMN     "led_holder_name" VARCHAR(80);
