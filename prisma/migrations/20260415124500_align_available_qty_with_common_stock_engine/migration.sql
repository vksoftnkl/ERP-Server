...
SET "isb_available_qty" = ("isb_closing_qty" - "isb_reserved_qty")
WHERE "isb_available_qty" IS DISTINCT FROM ("isb_closing_qty" - "isb_reserved_qty");
...
SET "ibs_available_qty" = ("ibs_closing_qty" - "ibs_reserved_qty")
WHERE "ibs_available_qty" IS DISTINCT FROM ("ibs_closing_qty" - "ibs_reserved_qty");
