-- Seed: fixed.form_section -- the widget-master tabs of each entry form (43 rows).
--
...
SELECT v.* FROM (VALUES
    ...
    -- ============ Suppliers (id 22) ============
    ,(62, 22 , 'suppliers-Identity'         , 'Identity'        , 1, true, 'Web'    , 'system')
    ,(63, 22 , 'supplier-notes'             , 'Notes'           , 2, true, 'Web'    , 'system')
    ,(64, 22 , 'suppliers-regionaldetails'  , 'Regional Details', 3, true, 'Web'    , 'system')
    -- ============ Supplier Groups (id 27) ============
    ,(12, 27 , 'supplier group list'        , 'basic'           , 1, true, 'Web'    , 'system')
    -- ============ Item Master (id 29) ============
    ,(69, 29 , 'Item Master-Core'           , 'Core Details'    , 1, true, 'Web'    , 'system')
    ,(70, 29 , 'Item Master-Ean Table'      , 'Ean Table'       , 2, true, 'Web'    , 'system')
    ,(71, 29 , 'Item Master-Inventory&Notes', 'Inventory&Notes' , 3, true, 'Web'    , 'system')
