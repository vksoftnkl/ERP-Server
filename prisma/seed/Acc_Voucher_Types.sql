...
VALUES
     (1::integer, 'Opn'::varchar, 'Opening Stock'::varchar, 'Opn'::varchar, 'INVENTORY'::accounts."VoucherCategory", 'STOCK_JOURNAL'::accounts."VoucherNature", 'MANUAL'::accounts."VoucherNumberingMode", 'OPN'::varchar, ''::varchar, 4::integer, 'YEARLY'::accounts."VoucherResetFreq", false::boolean, false::boolean, true::boolean, false::boolean, false::boolean, 'Opening Stock'::varchar, 100::integer, true::boolean, true::boolean, NULL::varchar, NULL::varchar, 'system'::varchar)
    ,(2, 'Quo', 'Sales Quotation'      , 'Quo', 'INVENTORY' , 'SALES'        , 'AUTO'  , 'Q'  , NULL, 4 , 'YEARLY', false, false, true , false, false, 'QUOTATION'      , 200, true, false, NULL     , NULL     , 'system')
