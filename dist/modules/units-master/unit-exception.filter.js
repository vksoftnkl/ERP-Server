...
exports.UnitExceptionFilter = void 0;
const common_1 = require("@nestjs/common");
let UnitExceptionFilter = class UnitExceptionFilter {
    catch(exception, host) {
        const response = host.switchToHttp().getResponse();
        if (exception instanceof common_1.HttpException) {
            const statusCode = exception.getStatus();
            const rawResponse = exception.getResponse();
            if (this.isUnitErrorResponse(rawResponse)) {
    ...
    inferFieldName(message) {
        const fieldMatch = message.match(/\b(unit_[a-z0-9_]+)\b/i);
        if (fieldMatch) {
            return fieldMatch[1];
        }
        return 'request';
...
exports.UnitExceptionFilter = UnitExceptionFilter;
exports.UnitExceptionFilter = UnitExceptionFilter = __decorate([
    (0, common_1.Catch)()
], UnitExceptionFilter);
//# sourceMappingURL=unit-exception.filter.js.map