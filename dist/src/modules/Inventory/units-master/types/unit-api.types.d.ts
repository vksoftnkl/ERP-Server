export type { InventoryErrorDetail as UnitErrorDetail } from "../../../../common/types/module-api.types";
export type { InventoryErrorResponse as UnitErrorResponse } from "../../../../common/types/module-api.types";
export type { InventorySuccessResponse as UnitSuccessResponse } from "../../../../common/types/module-api.types";
...
export type UnitDetailPayload = Omit<UnitPayload, 'unit_is_deleted' | 'unit_sync_date' | 'unit_created_on' | 'unit_created_by' | 'unit_modified_on' | 'unit_modified_by'>;
