...
export declare class ItemTaxPayloadDto {
    tax_id: string;
    tax_name: string;
...
export declare class ItemTaxDeleteResultDto {
    tax_id: string;
    deleted: boolean;
}
export declare class ItemTaxSuccessSingleDto {
    success: true;
    message: string;
    data: ItemTaxPayloadDto;
}
export declare class ItemTaxSuccessDeleteDto {
    success: true;
    message: string;
