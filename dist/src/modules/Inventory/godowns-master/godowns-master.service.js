...
let GodownsMasterService = class GodownsMasterService {
    ...
    async getById(gdlId) {
        ...
        if (!record) {
            (0, module_service_utils_1.throwInventoryNotFound)('Godown location not found', 'gdl_id', `No active godown location found with id ${gdlId}`);
        }
    ...
    async createGodownLocation(saveGodownDto) {
        ...
        try {
            return await this.prisma.$transaction(async (tx) => {
                ...
                const data = {
                    ...
                    gdlName,
                    gdlCreatedOn: now,
                    gdlCreatedBy: this.requestContextService.getUserId() ?? module_service_utils_1.DEFAULT_ACTOR,
                };
    ...
    async updateGodownLocation(saveGodownDto) {
        ...
        try {
            return await this.prisma.$transaction(async (tx) => {
                ...
                data.gdlModifiedBy = this.requestContextService.getUserId() ?? module_service_utils_1.DEFAULT_ACTOR;
    ...
    normalizeLegacySaveGodownDto(saveGodownDto) {
        const normalized = { ...saveGodownDto };
    ...
    validateCreatePayload(saveGodownDto) {
    ...
    async findActiveLocation(client, gdlId) {
    ...
    async getParentName(client, parentId) {
        if (!parentId) {
            return null;
        }
    ...
    async getBranchName(client, branchId) {
        if (!branchId) {
            return null;
        }
    ...
    async getActiveLocationOrThrow(client, gdlId) {
    ...
    async validateParentAssignment(tx, params) {
        if (!params.parentId) {
            return;
        }
    ...
    async ensureSelfInPath(tx, gdlId) {
    ...
    applyOptionalFields(data, saveGodownDto) {
        if ((0, module_service_utils_1.hasOwnProperty)(saveGodownDto, 'gdl_branch_id') &&
            saveGodownDto.gdl_branch_id !== undefined) {
            data.gdlBranchId = saveGodownDto.gdl_branch_id;
        }
        if ((0, module_service_utils_1.hasOwnProperty)(saveGodownDto, 'gdl_short') && saveGodownDto.gdl_short !== undefined) {
            data.gdlShort = saveGodownDto.gdl_short;
        }
        if ((0, module_service_utils_1.hasOwnProperty)(saveGodownDto, 'gdl_code') && saveGodownDto.gdl_code !== undefined) {
            data.gdlCode = saveGodownDto.gdl_code;
        }
        if ((0, module_service_utils_1.hasOwnProperty)(saveGodownDto, 'gdl_type') && saveGodownDto.gdl_type !== undefined) {
        ...
        if ((0, module_service_utils_1.hasOwnProperty)(saveGodownDto, 'gdl_split_stock') &&
            saveGodownDto.gdl_split_stock !== undefined) {
            data.gdlSplitStock = saveGodownDto.gdl_split_stock;
        }
        if ((0, module_service_utils_1.hasOwnProperty)(saveGodownDto, 'gdl_negative_stock') &&
            saveGodownDto.gdl_negative_stock !== undefined) {
            data.gdlNegativeStock = saveGodownDto.gdl_negative_stock;
        }
        if ((0, module_service_utils_1.hasOwnProperty)(saveGodownDto, 'gdl_volume') && saveGodownDto.gdl_volume !== undefined) {
            data.gdlVolume = saveGodownDto.gdl_volume;
        }
        if ((0, module_service_utils_1.hasOwnProperty)(saveGodownDto, 'gdl_is_active') &&
            saveGodownDto.gdl_is_active !== undefined) {
            data.gdlIsActive = saveGodownDto.gdl_is_active;
        }
        if ((0, module_service_utils_1.hasOwnProperty)(saveGodownDto, 'gdl_remarks') && saveGodownDto.gdl_remarks !== undefined) {
    ...
    toPayload(record) {
        return {
            ...
            gdl_volume: (0, module_service_utils_1.toNumber)(record.gdlVolume),
    ...
    handleWriteError(error) {
        (0, module_service_utils_1.throwOnUniqueConstraintError)(error, 'Godown location already exists', [
...
exports.GodownsMasterService = GodownsMasterService;
exports.GodownsMasterService = GodownsMasterService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService,
        audit_log_service_1.AuditLogService,
        request_context_service_1.RequestContextService])
], GodownsMasterService);
//# sourceMappingURL=godowns-master.service.js.map