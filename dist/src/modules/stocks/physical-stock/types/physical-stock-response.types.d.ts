...
export declare class PhysicalStockHeaderResponseDto implements PhysicalStockHeaderResponse {
    psc_id: string;
    psc_refno: string;
    psc_date: string;
}
export declare class PhysicalStockBatchDetailResponseDto implements PhysicalStockBatchDetailResponse {
    psb_id: string;
    psb_psd_id: string;
    psb_row_no: number;
}
export declare class PhysicalStockDetailResponseDto implements PhysicalStockDetailResponse {
    psd_id: string;
    psd_psc_id: string;
    psd_row_no: number;
    batch_details: PhysicalStockBatchDetailResponse[];
}
export declare class PhysicalStockDocumentResponseDto implements PhysicalStockDocumentResponse {
    header: PhysicalStockHeaderResponse;
    details: PhysicalStockDetailResponse[];
}
export declare class PhysicalStockDeleteResponseDto implements PhysicalStockDeleteResponse {
    ps_id: string;
    deleted: true;
}
export declare class PhysicalStockSuccessSingleDto {
    success: true;
    message: string;
    data: PhysicalStockDocumentResponse;
}
export declare class PhysicalStockSuccessDeleteDto {
    success: true;
    message: string;
