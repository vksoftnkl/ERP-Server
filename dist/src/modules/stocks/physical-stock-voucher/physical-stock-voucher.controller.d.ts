...
import type { PagedResult, StockCountSheetRow, StockVarianceRow, StockVoucherCancelResult, StockVoucherDeleteResult, StockVoucherLineProblem, StockVoucherListResult, StockVoucherPayload, StockVoucherPostResult, StockVoucherSuccessResponse } from '../stock-voucher/types/stock-voucher.types';
...
export declare class PhysicalStockVoucherController {
    ...
    remove(query: PhysicalStockVoucherRefQueryDto): Promise<StockVoucherSuccessResponse<StockVoucherDeleteResult>>;
