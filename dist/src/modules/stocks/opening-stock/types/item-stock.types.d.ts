export declare enum StockTrackingType {
    NONE = "NONE",
    MRP = "MRP",
    BATCH = "BATCH"
}
export declare enum StockTxnType {
    OPENING = "OPENING",
    PURCHASE = "PURCHASE",
...
export declare enum ItemStockBalanceTrackingType {
    NONE = "NONE",
    MRP = "MRP",
    BATCH = "BATCH"
}
export declare enum ItemStockBucket {
    SALEABLE = "SALEABLE",
    DAMAGED = "DAMAGED",
    EXPIRED = "EXPIRED",
    HOLD = "HOLD",
