...
export declare class OpeningStockHeaderPayloadDto {
...
export declare class OpeningStockDetailPayloadDto {
    osl_id: string;
...
export declare class OpeningStockDocumentPayloadDto {
    header: OpeningStockHeaderPayloadDto;
    details: OpeningStockDetailPayloadDto[];
}
export declare class OpeningStockListMetaDto {
    page: number;
    limit: number;
    total: number;
    total_pages: number;
...
export declare class OpeningStockSuccessSingleDto {
    success: true;
    message: string;
    data: OpeningStockDocumentPayloadDto;
}
export declare class OpeningStockSuccessListDto {
    success: true;
    message: string;
    data: OpeningStockHeaderPayloadDto[];
    meta: OpeningStockListMetaDto;
}
export declare class OpeningStockSuccessDeleteDto {
    success: true;
    message: string;
