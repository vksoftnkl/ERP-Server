export declare class ItemBatchStockErrorFieldDto {
    field: string;
    message: string;
}
export declare class ItemBatchStockErrorResponseDto {
    success: false;
    message: string;
    errors: ItemBatchStockErrorFieldDto[];
}
export declare class ItemBatchStockPayloadDto {
    ibs_id: string;
    ibs_acc_year: string;
...
export declare class ItemBatchStockSuccessListDto {
    success: true;
    message: string;
