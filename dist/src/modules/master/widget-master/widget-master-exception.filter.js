...
exports.WidgetMasterExceptionFilter = void 0;
const common_1 = require("@nestjs/common");
let WidgetMasterExceptionFilter = class WidgetMasterExceptionFilter {
    catch(exception, host) {
        const response = host.switchToHttp().getResponse();
        if (exception instanceof common_1.HttpException) {
            const statusCode = exception.getStatus();
            const rawResponse = exception.getResponse();
            if (this.isWidgetMasterErrorResponse(rawResponse)) {
    ...
    isWidgetMasterErrorResponse(value) {
    ...
    inferFieldName(message) {
        const fieldMatch = message.match(/\b((?:section|field|widget)[A-Za-z0-9]+)\b/);
        if (fieldMatch) {
            return fieldMatch[1];
        }
        return 'request';
...
exports.WidgetMasterExceptionFilter = WidgetMasterExceptionFilter;
exports.WidgetMasterExceptionFilter = WidgetMasterExceptionFilter = __decorate([
    (0, common_1.Catch)()
], WidgetMasterExceptionFilter);
//# sourceMappingURL=widget-master-exception.filter.js.map