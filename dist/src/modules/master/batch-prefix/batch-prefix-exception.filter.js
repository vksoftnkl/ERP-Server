...
exports.BatchPrefixExceptionFilter = void 0;
const common_1 = require("@nestjs/common");
const KNOWN_FIELDS = ['id', 'prefixUsed', 'syncDate', 'search', 'page', 'limit'];
let BatchPrefixExceptionFilter = class BatchPrefixExceptionFilter {
    ...
    isBatchPrefixErrorResponse(value) {
...
exports.BatchPrefixExceptionFilter = BatchPrefixExceptionFilter;
exports.BatchPrefixExceptionFilter = BatchPrefixExceptionFilter = __decorate([
    (0, common_1.Catch)()
], BatchPrefixExceptionFilter);
//# sourceMappingURL=batch-prefix-exception.filter.js.map