...
import { SaveDraftReceiptDto, UpdateReceiptHeaderDto } from './dto/save-receipt.dto';
...
export declare class ReceiptService {
    ...
    save(dto: SaveDraftReceiptDto): Promise<ReceiptDraftPayload>;
    saveInTransaction(tx: Prisma.TransactionClient, dto: SaveDraftReceiptDto, actor: string): Promise<ReceiptDraftPayload>;
