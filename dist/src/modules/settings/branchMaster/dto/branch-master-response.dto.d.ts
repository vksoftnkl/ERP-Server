export declare class BranchMasterErrorFieldDto {
    field: string;
    message: string;
}
export declare class BranchMasterErrorResponseDto {
    success: false;
    message: string;
    errors: BranchMasterErrorFieldDto[];
}
export declare class BranchMasterPayloadDto {
    brId: string;
    brCompId: string;
...
export declare class BranchMasterSuccessDeleteDto {
    success: true;
    message: string;
