...
exports.loadCanvasFixtureSample = loadCanvasFixtureSample;
...
function loadCanvasFixtureSample(name) {
    return JSON.parse((0, node_fs_1.readFileSync)((0, node_path_1.join)(__dirname, `${name}.sample.json`), 'utf8'));
}
