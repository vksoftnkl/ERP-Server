export declare class CustomerErrorFieldDto {
    field: string;
    message: string;
}
export declare class CustomerErrorResponseDto {
    success: false;
    message: string;
    errors: CustomerErrorFieldDto[];
}
export declare class CustomerPayloadDto {
    cusId: string;
...
export declare class CustomerDeleteResultDto {
    cusId: string;
    deleted: true;
}
export declare class CustomerSuccessSingleDto {
    success: true;
    message: string;
    data: CustomerPayloadDto;
}
export declare class CustomerSuccessDeleteDto {
    success: true;
    message: string;
